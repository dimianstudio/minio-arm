...
```
$ sudo docker pull dimianstudio/minio-arm
```
...
# Links
GitHub Repository - https://github.com/dimianstudio/minio-arm

Docker Hub Repository - https://hub.docker.com/r/dimianstudio/minio-arm
